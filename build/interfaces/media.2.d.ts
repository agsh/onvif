...
export type ConfigurationEnumeration = 'All' | 'VideoSource' | 'VideoEncoder' | 'AudioSource' | 'AudioEncoder' | 'AudioOutput' | 'AudioDecoder' | 'Metadata' | 'Analytics' | 'PTZ' | 'Receiver';
export type TransportProtocol = 'RtspUnicast' | 'RtspMulticast' | 'RtspsUnicast' | 'RtspsMulticast' | 'RTSP' | 'RtspOverHttp';
