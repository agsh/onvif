import { ReferenceToken, IntRange, Vector2D, Vector1D, PTZVector, MoveStatus, Rectangle, Vector, Transformation, Color } from './common';
...
export type ViewModes = 'tt:Fisheye' | 'tt:360Panorama' | 'tt:180Panorama' | 'tt:Quad' | 'tt:Original' | 'tt:LeftHalf' | 'tt:RightHalf' | 'tt:Dewarp';
...
export type ExtendedDirection = 'Left' | 'Right' | 'Any' | 'Entering' | 'Exiting' | 'Approaching' | 'Departing';
