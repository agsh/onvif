...
*/
OnvifLibrary.Discovery.on('device', function (cam, rinfo, xml) {
  ...
  parser.parseString(xml, function (err, result) {
    ...
    let urn =
      result['Envelope']['Body'][0]['ProbeMatches'][0]['ProbeMatch'][0]['EndpointReference'][0]['Address'][0].payload;
...
OnvifLibrary.Discovery.on('error', function (err, xml) {
