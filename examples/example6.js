 ...
 *
 * @see {events.with.filter.ts} for the new API calls including filtering
 */
...
if (EVENT_MODE == EventMethodTypes.SUBSCRIBE) {
  console.log(
    '** The camera will be told to send ONVIF Events to ' + EVENT_RECEIVER_IP_ADDRESS + ':' + EVENT_RECEIVER_PORT,
  );
}
console.log('*******************************************************************************');
