...
(function() {
  var assert, fs, onvif, serverMockup;
  ...
  describe('Common functions', function() {
    ...
    describe('getActiveSources', function() {
      ...
      return it('should populate activeSources and defaultProfiles when more than one video source exists', function() {
        return fs.rename('./serverMockup/GetVideoSources.xml', './serverMockup/GetVideoSources.single', function(err) {
          assert.equal(err, null);
          return fs.rename('./serverMockup/GetVideoSourcesEncoder.xml', './serverMockup/GetVideoSources.xml', function(err) {
            assert.equal(err, null);
            cam.getActiveSources();
            assert.isArray(cam.activeSources);
            assert.isArray(cam.defaultProfiles);
            return fs.rename('./serverMockup/GetVideoSources.xml', './serverMockup/GetVideoSourcesEncoder.xml', function(err) {
              assert.equal(err, null);
              return fs.rename('./serverMockup/GetVideoSources.single', './serverMockup/GetVideoSources.xml', function(err) {
