...
(function() {
  var Buffer, conf, dgram, discover, fs, http, listener, reBody, reCommand, reNS, template;
  ...
  listener = function(req, res) {
    ...
    return req.on('end', function() {
      ...
      return res.end(template(fs.readFileSync(__dirname + '/serverMockup/' + command + '.xml'))(conf));
    });
  };
