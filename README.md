...
The code, which use the old version of the library (0.6.x), should work using the compatibility class: 
https://github.com/agsh/onvif/blob/v1/src/compatibility/cam.ts where all methods are located.
