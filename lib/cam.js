 ...
 * @param {boolean} [options.autoConnect=true] Auto connect to the camera when it is constructed
...
var Cam = function(options, callback) {
	...
	this.events = {};
    if(!("autoConnect" in options) || typeof options.autoConnect === "undefined" || options.autoConnect === true) {
