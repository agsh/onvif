 ...
 * @param {boolean} [options.autoconnect] Default true. If false, then won't automatically connect to cameras. use Cam.connect() to make the connection.
...
var Cam = function(options, callback) {
	...
	var autoconnect = options.autoconnect || true; // backwards compatible
	/**
