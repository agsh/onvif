...
Cam.prototype.getPresets = function(options, callback) {
	...
	this._request({
		...
		if (!err) {
			this.presets = {};
			linerase(data).getPresetsResponse.preset.forEach(function(preset) {
 ...
 * @param {number} [options.x=0] Pan, float
 * @param {number} [options.y=0] Tilt, float
 * @param {number} [options.zoom=0] Zoom, float
 * @param {object} [options.speed] If the speed argument is omitted, the default speed set by the PTZConfiguration will be used.
 * @param {number} [options.speed.x] Pan speed, float
 * @param {number} [options.speed.y] Tilt speed, float
 * @param {number} [options.speed.zoom] Zoom speed, float
 ...
 * @param {object} options
 * @param {string} [options.profileToken=Cam#activeSource.profileToken]
 * @param {number} [options.x] Pan, float
 * @param {number} [options.y] Tilt, float
 * @param {number} [options.zoom] Zoom, float
 * @param {object} [options.speed] If the speed argument is omitted, the default speed set by the PTZConfiguration will be used.
 * @param {number} [options.speed.x] Pan speed, float
 * @param {number} [options.speed.y] Tilt speed, float
 * @param {number} [options.speed.zoom] Zoom speed, float
 ...
 * @param options
 * @param {string} [options.profileToken=Cam#activeSource.profileToken]
 * @param {number} [options.x=0] pan velocity, float
 * @param {number} [options.y=0] tilt velocity, float
 * @param {number} [options.zoom=0] zoom velocity, float
