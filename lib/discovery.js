 ...
 * @param {boolean} [options.useIPv6=false] set to true if you want to use IPv6 address. If a camera doesn't support IPv6 it falls back to IPv4.
				...
				if (!cams[camAddr]) {
					...
					if (options.resolve !== false) {
						...
						for (var i = 0; i < addresses.length; ++i) {
							var urlObj = url.parse(addresses[i]);
