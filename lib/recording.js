...
module.exports = function(Cam) {
	...
	Cam.prototype.getRecordingSummary = function(callback) {
		this._request({
			...
			if (!err) {
				this.recordingSummary = linerase(data).getRecordingSummaryResponse.recordingInformation;
			}
			if (callback) {
	...
	Cam.prototype.getRecordingInformation = function(options, callback) {
		this._request({
			...
			if (!err) {
				this.summary = linerase(data).getRecordingInformationResponse.recordingInformation;
			}
			if (callback) {
