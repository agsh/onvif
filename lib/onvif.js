...
Discovery.prototype.probe = function(callback) {
	var messageID = 'urn:uuid:3afd5e21-de48-4277-8119-f25ebdd9890a';

	callback = callback || function() {};
	var listener = function(msg, rinfo) {
		parseSOAPString(msg, function(err, data) {
	...
	this.socket.send(request, 0, request.length, 3702, '239.255.255.250');
