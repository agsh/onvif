	...
	*/
	...
	Cam.prototype.getOSDOptions = function(options, callback) {
		...
		this._request({
			...
			, body: this._envelopeHeader() +
				...
				'<GetOSDOptions xmlns="http://www.onvif.org/ver10/media/wsdl" >' +
	...
	Cam.prototype.createOSD = function(options, callback) {
		...
		this._request({
			service: 'media'
			, body: this._envelopeHeader() +
				`<wsdl:CreateOSD xmlns:wsdl="http://www.onvif.org/ver10/media/wsdl" xmlns:sch="http://www.onvif.org/ver10/schema">
         <wsdl:OSD token="">
	...
	Cam.prototype.setOSD = function(options, callback) {
		...
		this._request({
			service: 'media'
			, body: this._envelopeHeader() +
				`<wsdl:SetOSD xmlns:wsdl="http://www.onvif.org/ver10/media/wsdl" xmlns:sch="http://www.onvif.org/ver10/schema">
	...
	Cam.prototype.deleteOSD = function(token, callback) {
		this._request({
			service: 'media'
			, body: this._envelopeHeader() +
				'<DeleteOSD xmlns="http://www.onvif.org/ver10/media/wsdl">' +
