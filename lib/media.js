...
module.exports = function (Cam) {
    ...
    this._request(
      ...
      function (err, data, xml) {
        if (!err) {
           ...
           */
          this.videoSources =
            linerase(data).getVideoSourcesResponse.videoSources;
      ...
      function (err, data, xml) {
        if (!err) {
          this.videoSourceConfigurations =
            data[0].getVideoSourceConfigurationsResponse[0].configurations.map(
              function (data) {
  ...
  Cam.prototype.getVideoEncoderConfiguration = function (token, callback) {
    if (callback === undefined) {
      ...
      if (
        ...
        this.videoEncoderConfigurations[0]
      ) {
        token = this.videoEncoderConfigurations[0].$.token;
      } else {
        return callback(
          new Error("No video encoder configuration token is present!")
        );
      }
    }
    this._request(
        ...
        if (callback) {
          callback.call(
            ...
            err
              ? null
              : linerase(
                  data[0].getVideoEncoderConfigurationResponse[0].configuration
                ),
            xml
          );
        }
   ...
   */
  Cam.prototype.getVideoEncoderConfigurationOptions = function (
    options,
    callback
  ) {
    if (callback === undefined) {
      ...
      if (
        ...
        options = {
          configurationToken: this.videoEncoderConfigurations[0].$.token,
        };
      } else {
        return callback(
          new Error("No video encoder configuration token is present!")
      ...
      !(options && (options.configurationToken || options.profileToken))
    ) {
      return callback(
        new Error(
          "'options' must have one or both 'configurationToken' or 'profileToken'"
        )
      );
    }
    this._request(
        ...
        if (callback) {
          callback.call(
            ...
            err
              ? null
              : linerase(
                  data[0].getVideoEncoderConfigurationOptionsResponse[0].options
                ),
            xml
          );
        }
  ...
  Cam.prototype.getVideoEncoderConfigurations = function (callback) {
    this._request(
      ...
      function (err, data, xml) {
        if (!err) {
          this.videoEncoderConfigurations =
            data[0].getVideoEncoderConfigurationsResponse[0].configurations.map(
              function (config) {
    ...
    this._request(
      {
        ...
        body:
          ...
          (options.name
            ...
            : "") +
          (options.useCount
            ? '<UseCount xmlns="http://www.onvif.org/ver10/schema">' +
              options.useCount +
              "</UseCount>"
            : "") +
          (options.encoding
            ? '<Encoding xmlns="http://www.onvif.org/ver10/schema">' +
              options.encoding +
              "</Encoding>"
            : "") +
          (options.resolution
            ? '<Resolution xmlns="http://www.onvif.org/ver10/schema">' +
              (options.resolution.width
                ? "<Width>" + options.resolution.width + "</Width>"
                : "") +
              (options.resolution.height
                ? "<Height>" + options.resolution.height + "</Height>"
                : "") +
              "</Resolution>"
            : "") +
          (options.quality
            ? '<Quality xmlns="http://www.onvif.org/ver10/schema">' +
              options.quality +
              "</Quality>"
            : "") +
          (options.rateControl
            ? '<RateControl xmlns="http://www.onvif.org/ver10/schema">' +
              (options.rateControl.frameRateLimit
                ? "<FrameRateLimit>" +
                  options.rateControl.frameRateLimit +
                  "</FrameRateLimit>"
                : "") +
              (options.rateControl.encodingInterval
                ? "<EncodingInterval>" +
                  ...
                  "</EncodingInterval>"
                : "") +
              (options.rateControl.bitrateLimit
                ? "<BitrateLimit>" +
                  options.rateControl.bitrateLimit +
                  "</BitrateLimit>"
                : "") +
          ...
          (options.MPEG4
            ? '<MPEG4 xmlns="http://www.onvif.org/ver10/schema">' +
              (options.MPEG4.govLength
                ? "<GovLength>" + options.MPEG4.govLength + "</GovLength>"
                : "") +
              (options.MPEG4.profile
                ? "<MPEG4Profile>" + options.MPEG4.profile + "</MPEG4Profile>"
                : "") +
              "</MPEG4>"
            : "") +
          (options.H264
            ? '<H264 xmlns="http://www.onvif.org/ver10/schema">' +
              (options.H264.govLength
                ? "<GovLength>" + options.H264.govLength + "</GovLength>"
                : "") +
              (options.H264.profile
                ? "<H264Profile>" + options.H264.profile + "</H264Profile>"
                : "") +
              "</H264>"
            : "") +
          (options.multicast
              ...
              (options.multicast.address
                ? "<Address>" +
                  (options.multicast.address === 0
                    ? "0"
                    : (options.multicast.address.type
                        ? "<Type>" + options.multicast.address.type + "</Type>"
                        : "") +
                  ...
                  "</Address>"
                : "") +
              (options.multicast.port !== undefined
                ? "<Port>" + options.multicast.port + "</Port>"
                : "") +
              (options.multicast.TTL !== undefined
                ? "<TTL>" + options.multicast.TTL + "</TTL>"
                : "") +
              (options.multicast.autoStart !== undefined
                ? "<AutoStart>" + options.multicast.autoStart + "</AutoStart>"
                : "") +
              "</Multicast>"
            : "") +
      ...
      function (err, data, xml) {
        if (err || linerase(data).setVideoEncoderConfigurationResponse !== "") {
          return callback.call(
            this,
            linerase(data).setVideoEncoderConfigurationResponse !== ""
        ...
        this.getVideoEncoderConfiguration(
          options.token || options.$.token,
          callback
        );
      }.bind(this)
  ...
  Cam.prototype.getAudioSources = function (callback) {
    this._request(
      ...
      function (err, data, xml) {
        if (!err) {
          this.audioSources =
            data[0].getAudioSourcesResponse[0].audioSources.map(function (
              config
            ) {
              return linerase(config);
            });
  ...
  Cam.prototype.getAudioEncoderConfigurations = function (callback) {
    this._request(
      ...
      function (err, data, xml) {
        if (!err) {
          this.audioEncoderConfigurations =
            data[0].getAudioEncoderConfigurationsResponse[0].configurations.map(
              function (config) {
                return linerase(config);
              }
            );
  ...
  Cam.prototype.getAudioEncoderConfiguration = function (token, callback) {
    if (callback === undefined) {
      ...
      if (
        this.audioEncoderConfigurations &&
        this.audioEncoderConfigurations[0]
      ) {
        token = this.audioEncoderConfigurations[0].$.token;
      } else {
        return callback(
          new Error("No audio encoder configuration token is present!")
        );
      }
    }
    this._request(
        ...
        if (callback) {
          callback.call(
            ...
            err
              ? null
              : linerase(
                  data[0].getAudioEncoderConfigurationResponse[0].configuration
                ),
            xml
          );
        }
   ...
   */
  Cam.prototype.getAudioEncoderConfigurationOptions = function (
    token,
    callback
  ) {
    if (callback === undefined) {
        ...
        if (callback) {
          callback.call(
            ...
            err
              ? null
              : linerase(
                  data[0].getAudioEncoderConfigurationOptionsResponse[0].options
                ),
            xml
          );
        }
    ...
    this._request(
      {
        ...
        body:
          ...
          (options.encoding
            ...
            : "") +
          (options.bitrate
            ? '<Bitrate xmlns="http://www.onvif.org/ver10/schema">' +
              options.bitrate +
              "</Bitrate>"
            : "") +
          (options.sampleRate
            ? '<SampleRate xmlns="http://www.onvif.org/ver10/schema">' +
              options.sampleRate +
              "</SampleRate>"
            : "") +
          (options.multicast
      ...
      function (err, data, xml) {
        if (err || linerase(data).setAudioEncoderConfigurationResponse !== "") {
          return callback.call(
            this,
            linerase(data).setAudioEncoderConfigurationResponse !== ""
        ...
        this.getAudioEncoderConfiguration(
          options.token || options.$.token,
          callback
        );
      }.bind(this)
  ...
  Cam.prototype.getAudioSourceConfigurations = function (callback) {
    this._request(
      ...
      function (err, data, xml) {
        if (!err) {
          this.audioSourceConfigurations =
            data[0].getAudioSourceConfigurationsResponse[0].configurations.map(
              function (config) {
                return linerase(config);
              }
            );
  ...
  Cam.prototype.getAudioOutputs = function (callback) {
    this._request(
      ...
      function (err, data, xml) {
        if (!err) {
          this.audioOutputs =
            data[0].getAudioOutputsResponse[0].audioOutputs.map(function (
              config
            ) {
              return linerase(config);
            });
  ...
  Cam.prototype.getAudioOutputConfigurations = function (callback) {
    this._request(
      ...
      function (err, data, xml) {
        if (!err) {
          this.audioOutputConfigurations =
            data[0].getAudioOutputConfigurationsResponse[0].configurations.map(
              function (config) {
                return linerase(config);
              }
            );
   ...
   */
  Cam.prototype.removeAudioEncoderConfiguration = function (
    profileToken,
    callback
  ) {
    let body =
   ...
   */
  Cam.prototype.removeAudioSourceConfiguration = function (
    profileToken,
    callback
  ) {
    let body =
      ...
      this._request(
        ...
        function (err, data, xml) {
          ...
          if (!err) {
             ...
             */
            this.profiles = data[0]["getProfilesResponse"][0]["profiles"].map(
              function (profile) {
                ...
                if (tmp.configurations.videoSource) {
                  newProfile.videoSourceConfiguration =
                    tmp.configurations.videoSource;
                }
                if (tmp.configurations.audioSource) {
                  newProfile.audioSourceConfiguration =
                    tmp.configurations.audioSource;
                }
                if (tmp.configurations.videoEncoder) {
                  newProfile.videoEncoderConfiguration =
                    tmp.configurations.videoEncoder;
                }
                if (tmp.configurations.audioEncoder) {
                  newProfile.audioEncoderConfiguration =
                    tmp.configurations.audioEncoder;
                }
                if (tmp.configurations.PTZ) {
                  newProfile.PTZConfiguration = tmp.configurations.PTZ;
                }
                if (tmp.configurations.analytics) {
                  newProfile.analyticsConfiguration =
                    tmp.configurations.analytics;
                }
                if (tmp.configurations.metadata) {
                  newProfile.metadataConfiguration =
                    tmp.configurations.metadata;
                }
                if (tmp.configurations.audioOutput) {
                  newProfile.audioOutputConfiguration =
                    tmp.configurations.audioOutput;
                }
                if (tmp.configurations.audioOutput) {
                  newProfile.audioDecoderConfiguration =
                    tmp.configurations.audioDecoder;
                }
      ...
      function (err, data, xml) {
        if (callback) {
          callback.call(
            this,
            err,
            err ? null : linerase(data).createProfileResponse.profile,
            xml
          );
        }
      }.bind(this)
      ...
      function (err, data, xml) {
        if (callback) {
          callback.call(
            this,
            err,
            err ? null : linerase(data).deleteProfileResponse,
            xml
          );
        }
      }.bind(this)
        ...
        function (err, data, xml) {
          if (callback) {
            callback.call(
              this,
              err,
              err ? null : linerase(data).getStreamUriResponse,
              xml
            );
          }
        }.bind(this)
        ...
        function (err, data, xml) {
          if (callback) {
            callback.call(
              this,
              err,
              err ? null : linerase(data).getStreamUriResponse.mediaUri,
              xml
            );
          }
        }.bind(this)
        ...
        function (err, data, xml) {
          if (callback) {
            ...
            callback.call(
              this,
              err,
              err ? null : { uri: linerase(data).getSnapshotUriResponse.uri },
              xml
            );
          }
        }.bind(this)
        ...
        function (err, data, xml) {
          if (callback) {
            callback.call(
              this,
              err,
              err ? null : linerase(data).getSnapshotUriResponse.mediaUri,
              xml
            );
          }
        }.bind(this)
  ...
  Cam.prototype.getOSDs = function (token, callback) {
    ...
    let mediaNS = this.media2Support
        ...
        body:
          ...
          `<wsdl:SetOSD xmlns:wsdl="${mediaNS}" xmlns:sch="http://www.onvif.org/ver10/schema">
			 <wsdl:OSD token="${options.OSDToken}">
				<sch:VideoSourceConfigurationToken>${
          options.videoSourceConfigurationToken ||
          this.activeSource.videoSourceConfigurationToken
        }</sch:VideoSourceConfigurationToken>
				<sch:Type>Text</sch:Type>
				<sch:Position>
    ...
    this._request(
      ...
      function (err, data, xml) {
        if (callback) {
          if (!err) {
            data = linerase(
              data[0].getServiceCapabilitiesResponse[0].capabilities
            );
