 ...
 * @param {number} options.encodingInterval
 * @param {number} options.bitRate
 * @param {number} options.H264govLength
 * @param {string} options.H264profile
 * @param {number} options.MPEG4govLength
 * @param {string} options.MPEG4profile
 * @param {string} options.multicastAddressType
 * @param {string} options.multicastAddress
 * @param {number} options.multicastPort
 * @param {number} options.multicastTTL
 * @param {boolean} options.multicastAutoStart
