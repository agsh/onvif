 ...
 * @property {int} govLength
 * @property {string} profile
 * @property {duration} sessionTimeout
 */
 ...
 * @patam {int} [options.govLength]
 * @patam {string} [options.profile]
	...
	this._request({
		...
		'<SetVideoEncoderConfiguration xmlns="http://www.onvif.org/ver10/media/wsdl">' +
			...
			'<H264 xmlns="http://www.onvif.org/ver10/schema">' +
				'<GovLength>' + options.govLength + '</GovLength>' +
				'<H264Profile>' + options.profile + '</H264Profile>' +
			'</H264>' : '') +
			(options.encoding === 'MPEG4' ? 
			'<MPEG4 xmlns="http://www.onvif.org/ver10/schema">' +
				'<GovLength>' + options.govLength + '</GovLength>' +
				'<MPEG4Profile>' + options.profile + '</MPEG4Profile>' +
			'</MPEG4>' : '') +
